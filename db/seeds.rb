...
# ユーザー
user1 = User.create(name: "山田太郎", password_digest: "password1")
user2 = User.create(name: "鈴木花子", password_digest: "password2")

# 長期目標
ltg1 = LongTermGoal.create(user: user1, long_goal: "Ruby on Railsのプロフェッショナルになる", deadline: "2025-12-31")
ltg2 = LongTermGoal.create(user: user2, long_goal: "フルマラソンを完走する", deadline: "2024-06-30")

# 中期目標
mtg1 = MidTermGoal.create(user: user1, long_term_goal: ltg1, mid_goal: "オンラインのRailsコースを修了する", what_to_do: "毎日1時間勉強する", why_to_do: "スキルを身につけるため", current_status: "コースの半分が完了", why_current_status: "毎日継続しているため", what_next: "残りのコースを終える", priority: 2, deadline: "2025-06-30")
mtg2 = MidTermGoal.create(user: user2, long_term_goal: ltg2, mid_goal: "10kmを止まらずに走る", what_to_do: "毎週末にランニングする", why_to_do: "持久力をつけるため", current_status: "5km走れるようになった", why_current_status: "毎週トレーニングしているため", what_next: "次は7kmに挑戦する", priority: 3, deadline: "2024-03-31")
